...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            num_feature = ['Age','Absences','GradeClass']
            cat_feature = ['Gender']
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            target_columns_name = "GPA"

            # splite train dataset feature and label
